...
5.       Q. SOQL: Ask to write the developer  
...
2.       Q. Do you use VC and CI systems like Git and Jenkins? Why (Why yes, or why no)? Basic Git questions (in case person have some experience with it): Merge vs Rebase, Interactive Rebase, Cherry Pick, HEAD and moving through the branches.
...
*Typical questions:* Visualforce related: What is viewstate, how to use static resources, questions about tags and forms (actionSupport, actionRegion, etc). 
*Typical answers:* Ctrl+C + Ctrl+V
